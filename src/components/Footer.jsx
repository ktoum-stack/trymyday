...
const Footer = () => {
    const { t } = useLanguage();
    return (
        <footer className="footer-premium pt-4 pb-3 pb-lg-2 mt-auto" style={{
            background: 'linear-gradient(180deg, #1c1c1c 0%, #0a0a0a 100%)',
            borderTop: '4px solid #ff6000',
            color: '#ffffff'
        }}>
            <Container>
                <Row className="gy-4 gy-md-3">
                    {/* Brand Section */}
                    <Col lg={5} md={12} className="mb-4 mb-lg-0 text-start">
                        <div className="mb-3">
                            <h4 className="fw-bold mb-1" style={{ letterSpacing: '1px', color: '#ff6000' }}>TRYMYDAY</h4>
                            <p className="small opacity-75" style={{ maxWidth: '350px', lineHeight: '1.6', color: '#e0e0e0' }}>
                                {t('footer.description')}
                            </p>
                        </div>
                        <div className="d-flex gap-4 mb-4 justify-content-start">
                    ...
                    {/* Support */}
                    <Col lg={3} md={6} sm={12} className="text-start">
                    ...
                    {/* Contact Info */}
                    <Col lg={4} md={6} sm={12} className="text-start mt-2 mt-lg-0">
                ...
                <Row className="align-items-center pb-2 text-start text-md-start">
                    ...
                    <Col md={6} className="text-start text-md-end">
                        <div className="d-flex gap-4 justify-content-start justify-content-md-end text-white-50 fs-4 opacity-75">
            ...
            <style>{`
                ...
                @media (max-width: 767px) {
                    .footer-premium {
                        padding-bottom: 85px !important; /* Espace pour la bottom nav */
                    }
                    .footer-premium h6 {
                        margin-top: 15px;
                    }
